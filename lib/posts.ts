...
export const posts: Post[] = [
  {
    ...
    description:
      "ChatGPT·Gemini가 답변할 때 우리 브랜드가 언급되게 하는 GEO, 검색 답변에 먼저 인용되게 하는 AEO. 두 개념의 차이와 지금 당장 적용할 방법을 정리했습니다.",
    date: "2026-06-16",
    readingMin: 6,
    ...
    blocks: [
      {
        type: "p",
        text: "“검색하면 우리가 1등으로 떠요”라는 말이 더 이상 충분하지 않은 시대가 됐습니다. 사람들은 점점 네이버에 키워드를 치는 대신 ChatGPT나 Gemini에게 ‘어디가 괜찮아?’라고 묻습니다. 이때 AI가 우리 브랜드를 언급하느냐 마느냐가 새로운 승부처입니다. 그 핵심이 바로 GEO와 AEO입니다.",
      },
      ...
      {
        type: "p",
        text: "GEO는 ChatGPT·Gemini 같은 ‘생성형 AI’가 답변을 만들 때 우리 브랜드를 추천하거나 인용하도록 만드는 최적화입니다. 검색 순위를 올리는 게 아니라, AI의 ‘대답’ 안에 들어가는 것이 목표입니다.",
      },
      {
        type: "ul",
        items: [
      ...
      { type: "h2", text: "지금 당장 할 수 있는 5가지" },
      {
        ...
        items: [
          ...
          "ChatGPT·Gemini에 우리 브랜드를 직접 검색해 ‘지금 뭐라고 답하는지’ 확인하기",
      ...
      {
        type: "p",
        text: "AI 검색은 이미 시작됐고, 먼저 자리 잡는 쪽이 오래 유리합니다. 지금 우리 브랜드가 네이버·ChatGPT·Gemini에서 어떻게 보이는지 점검해 보고 싶다면, 카카오톡으로 편하게 말 걸어 주세요. 키워드별로 실제 노출을 측정해 어디부터 손볼지 알려드리겠습니다.",
      },
    ],
  },
];
